...
export type PartnerLogoImage = {
  asset?: SanityImageAssetReference;
  media?: unknown; // Unable to locate the referenced type "partnerLogo.image.media" in schema
  hotspot?: SanityImageHotspot;
  crop?: SanityImageCrop;
  _type: "image";
};
...
export type GridRow = {
  ...
  maxWidth?: "narrow" | "content" | "default" | "wide" | "full";
...
export type MicroFooterLine = {
  _type: "microFooterLine";
  variant?: "global" | "academy";
  blockStyles?: BlockStyles;
};

export type TagPills = {
  _type: "tagPills";
  items: Array<string>;
  tone?: "solid" | "outline";
  blockStyles?: BlockStyles;
...
export type FaqBlock = {
  _type: "faqBlock";
  variation?: "default" | "grouped" | "stacked";
  eyebrow?: string;
  title?: string;
  subtitle?: string;
  showCta?: boolean;
...
export type HeroSection = {
  ...
  overlay?: number;
  hubOverlay?: boolean;
  minHeight?: "auto" | "50vh" | "70vh" | "75vh" | "100vh";
...
export type RichTextBlock = {
  ...
  eyebrowTone?: "primary" | "muted" | "secondary";
  content: BlockContent;
  blockStyles?: BlockStyles;
};
...
export type SiteSettings = {
  ...
  footerTaglineLinkText?: string;
  footerTaglineLinkHref?: string;
  footerAboutLinks?: Array<
    {
      _key: string;
    } & FooterNavLink
  >;
  footerAcademyLinks?: Array<
    {
      _key: string;
    } & FooterNavLink
  >;
  footerGlobalLinks?: Array<
    {
      _key: string;
    } & FooterNavLink
  >;
  footerConnectCtaText?: string;
  footerConnectCtaUrl?: string;
  footerContactEmail?: string;
  footerWhatsappNumber?: string;
  footerContactAddress?: string;
  footerContactCity?: string;
...
// Query: *[_id == "homePage"][0] {      seo {    metaTitle, metaDescription, noIndex,    ogImage { asset->{ _id, url } }  },      pageBuilder[] {    _key, _type, ...,      _type == "heroSection" => {    ...,    // Slideshow layout    slides[] { _key, tag, headline, subtitle },    backgroundVideos[] {      _key, title,      "videoUrl": video.asset->url,      poster {        asset->{ url, metadata { lqip, dimensions { width, height } } }      }    },    // Primary / secondary buttons for slideshow    primaryButton,    secondaryButton,    pills,    prospectusLink,    slideDurationMs,    // Non-slideshow layout    buttons[] { _key, _type, ...,   blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  } },    mediaImage {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop },    backgroundImage {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop },    "backgroundVideoUrl": backgroundVideo.asset->url,      blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }  },    columns[] {      _key, ...,        content[] {    _key, _type, ...,    _type == "imageBlock" => {      image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop },      caption,      display,        blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }    },    _type == "richTextBlock" => {      eyebrow,      leadingIcon,      eyebrowTone,      content[] { ... },        blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }    },    _type == "logoRow" => {      logos[] { image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, alt, link },      displayStyle, gridColumns,      grayscale, size,        blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }    },    _type == "partnersNetwork" => {      eyebrow, heading, subtitle, logosLabel,      logos[] { _key, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, alt, link },      displayStyle, gridColumns, grayscale, size,        blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }    },    _type == "testimonialQuote" => {      ...,      avatar {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop },        blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }    },    _type == "iconText" => {      ...,      icon {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop },        blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }    },    _type == "featureCardGrid" => {      eyebrow,      showStepNumbers,      gridLayout,      stepNumberOffset,      ...,      cards[] {        _key, _type,        accentColor,        accentApplyTo,        title,        subtitle,        description,        bestFor,        includes,        note,        cta,        coverImage {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop },        icon {          source,          lucide,          image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }        }      },        blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }    },    _type == "experienceCardGrid" => {      ...,      eyebrow,      bodyParagraph,      locationLabel,      titleAlign,      footerText,      footerHighlight,      footerHighlightColor,      ctaLabel,      ctaHref,      cards[] {        _key, _type,        title,        alt,        description,        image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }      },        blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }    },    _type == "approachCarousel" => {      ...,      cards[] {        _key, _type,        label,        title,        description,        accentColor,        icon {          source,          lucide,          image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }        }      },        blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }    },    _type == "testimonialCarousel" => {      ...,      eyebrow,      titleAlign,      testimonials[] {        ...,        tag,        avatar {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop },          blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }      },        blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }    },    _type == "faqBlock" => {      ...,      variation,      eyebrow,      showCta,      ctaLabel,      items[] { _key, _type, question, answer[] { ... } },      groups[] {        _key, _type, label, accent,        items[] { _key, _type, question, answer[] { ... } }      },        blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }    },    _type == "tagPills" => {      items,        blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }    },    _type == "ctaSection" => {      eyebrow, heading, subtitle, size, postButtonText,      bodyParagraphs[] { _key, text, emphasis },      buttons[] {        _key, _type, label, action, color, textColor, hoverColor, variant,        link[] { ... }      },      trustItems,      prospectusLink {        label,        link[] { ... }      },        blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }    },      blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }  },        blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }    },      blockStyles {    padding, margin, border, borderTop, borderRadius,    background { color, image {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop }, size, overlay },    typography, effects  }  }  }
  ...
  | {
      ...
      pageBuilder: Array<
        | {
            ...
            columns: Array<{
              ...
              content: Array<
                ...
                | {
                    _key: string;
                    _type: "faqBlock";
                    variation: "default" | "grouped" | "stacked" | null;
                    eyebrow: string | null;
                    title?: string;
                    subtitle?: string;
                ...
                | {
                    ...
                    displayStyle: "grid" | "row" | null;
                    gridColumns: 3 | 4 | 5 | 6 | null;
                ...
                | {
                    ...
                    eyebrowTone: "muted" | "primary" | "secondary" | null;
                    content: Array<
                      | {
                          children?: Array<{
                            marks?: Array<string>;
              ...
              > | null;
              verticalAlign?: "bottom" | "center" | "sticky" | "top";
              blockStyles: {
                padding: Padding | null;
                margin: Margin | null;
                border: Border | null;
            ...
            paddingX?: "lg" | "md" | "none" | "sm";
            maxWidth?: "content" | "default" | "full" | "narrow" | "wide";
        ...
        | {
            ...
            overlay?: number;
            hubOverlay?: boolean;
            minHeight?: "100vh" | "50vh" | "70vh" | "75vh" | "auto";
            verticalAlign?: "center" | "end";
            textColor?: string;
...
// Query: *[_type == "page" && defined(slug.current) && !(_id in path("drafts.**"))] {    "slug": slug.current,    "sectionCount": count(coalesce(pageBuilder, []))  } | order(sectionCount desc) {    "slug": slug  }
...
// Query: *[_id == "siteSettings"][0] {    siteName, tagline,    logo {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop },    primaryColor, secondaryColor,    socialLinks[] { _key, platform, url },    mainNav[] {      _key, _type, label, href, isButton,      _type == "navDropdown" => {        items[] { _key, label, href, description, icon {   asset->{    _id,    url,    metadata { lqip, dimensions { width, height } }  },  alt,  hotspot,  crop } }      }    },    footerTagline,    footerTaglineLinkText,    footerTaglineLinkHref,    footerAboutLinks[] { _key, text, url, newTab },    footerAcademyLinks[] { _key, text, url, newTab },    footerGlobalLinks[] { _key, text, url, newTab },    footerConnectCtaText,    footerConnectCtaUrl,    footerContactEmail,    footerWhatsappNumber,    footerContactAddress,    footerContactCity,    footerBrandLine,    footerCopyrightName,    footerLegalLinks[] { _key, text, url, newTab }  }
export type SITE_SETTINGS_QUERY_RESULT =
  | {
      ...
      mainNav: null;
      footerTagline: null;
      footerTaglineLinkText: null;
      footerTaglineLinkHref: null;
      footerAboutLinks: null;
      footerAcademyLinks: null;
      footerGlobalLinks: null;
      footerConnectCtaText: null;
      footerConnectCtaUrl: null;
      footerContactEmail: null;
      footerWhatsappNumber: null;
      footerContactAddress: null;
      footerContactCity: null;
      footerBrandLine: null;
