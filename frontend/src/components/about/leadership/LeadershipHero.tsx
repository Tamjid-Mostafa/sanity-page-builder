...
export function LeadershipHero() {
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] rounded-full bg-primary/15 blur-3xl pointer-events-none" />
          ...
          <div className="flex flex-col gap-5 max-w-2xl">
            ...
            >
              ...
              <span className="text-secondary">
                responsibility and thoughtful design.
              </span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0 }}
            ...
            >
              iCollege Life is led with experience and intention — recognising
              the responsibility that comes with designing environments where
              people learn, grow, and develop direction over time.
            </motion.p>
          </div>
        </div>
      </div>
