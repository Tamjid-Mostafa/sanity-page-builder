...
export function GlobalHero() {
  return (
    <section
      ...
      aria-label="iCollege Global"
    >
      <div className="absolute inset-0 bg-linear-to-br from-[#0a1628] via-[#0c2340] to-[#0f1f35]" />
      <div className="absolute top-0 right-0 w-[700px] h-[700px] rounded-full bg-secondary/20 blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] rounded-full bg-primary/10 blur-3xl pointer-events-none" />
      <div className="absolute top-1/3 right-1/3 w-[300px] h-[300px] rounded-full bg-secondary/8 blur-2xl pointer-events-none" />
      ...
      <div className="relative z-10 w-full">
        <div className="container mx-auto px-6 sm:px-8 lg:px-12 pb-14 md:pb-16 lg:pb-20">
          <div className="flex flex-col gap-5 max-w-lg">
            ...
            >
              Global learning,{" "}
              <span className="text-secondary">designed with intention.</span>
            </motion.h1>
            ...
            <motion.p
              ...
              className="text-sm sm:text-base font-bold leading-relaxed text-white max-w-[44ch]"
            >
              Short-term international learning experiences that help young
              adults gain perspective, confidence, and direction through
              real-world experience, life design, and global networks.
            </motion.p>
