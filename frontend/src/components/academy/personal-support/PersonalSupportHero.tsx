...
export function PersonalSupportHero() {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-1/3 w-[500px] h-[500px] rounded-full bg-primary/10 blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 w-full">
        <div className="container mx-auto px-6 sm:px-8 lg:px-12 pb-14 md:pb-16 lg:pb-20">
          <div className="flex flex-col gap-5 max-w-lg">
            ...
            >
              iCollege Academy · Personal Support
            </motion.span>
            ...
            >
              Support that goes{" "}
              <span className="text-secondary">beyond tutoring.</span>
            </motion.h1>
            ...
            >
              At iCollege Academy, academic progress, confidence, and direction
              are supported together through mentoring, structured guidance, and
            ...
            >
              {["Mentoring", "Life Design", "Family Partnership", "Ages 15–18"].map((pill) => (
                <span
                  key={pill}
