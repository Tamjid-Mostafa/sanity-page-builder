...
export function PersonalSupportFinalCTA() {
  return (
    <SectionFrame id="personal-support-cta" className="bg-background">
      <div className="flex flex-col items-center text-center">
        ...
        >
          The best way to understand how support works is through a conversation.
        </motion.h2>
        ...
        >
          Book a short call to explore whether iCollege Academy is the right fit
          for you. There&apos;s no obligation — just an open, honest conversation.
        </motion.p>
