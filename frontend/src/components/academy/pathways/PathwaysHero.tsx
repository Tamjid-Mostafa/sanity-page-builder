...
export function PathwaysHero() {
  return (
    <section
      ...
      aria-label="Pathways & Outcomes"
    >
      <div className="absolute inset-0 bg-linear-to-br from-slate-900 via-[#0c1e35] to-[#112840]" />
      <div className="absolute top-0 left-0 w-[600px] h-[600px] rounded-full bg-primary/15 blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-[500px] h-[500px] rounded-full bg-secondary/10 blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 w-full">
        <div className="container mx-auto px-6 sm:px-8 lg:px-12 pb-14 md:pb-16 lg:pb-20">
          <div className="flex flex-col gap-5 max-w-lg">
            ...
            >
              iCollege Academy · Pathways &amp; Outcomes
            </motion.span>
            ...
            >
              Education that{" "}
              <span className="text-secondary">leads somewhere.</span>
            </motion.h1>
            ...
            >
              iCollege Academy prepares students aged 15–18 for thoughtful next
              steps — including university, global experiences, and other
              well-considered pathways beyond school.
            </motion.p>
            ...
            <motion.p
              ...
              className="text-sm leading-relaxed text-white/80 max-w-[42ch] font-light"
            >
              The goal is not simply completion, but progression with clarity
              and confidence.
            </motion.p>
