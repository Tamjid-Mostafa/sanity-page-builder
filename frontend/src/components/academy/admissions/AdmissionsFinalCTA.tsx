...
export function AdmissionsFinalCTA() {
  return (
    <SectionFrame id="admissions-cta" className="bg-foreground">
      <div className="flex flex-col items-center text-center">
        ...
        >
          The best first step is a short call.
        </motion.h2>
        ...
        >
          Book a short call to explore whether iCollege Academy is the right
          fit for you. There&apos;s no obligation — just an open conversation.
        </motion.p>
