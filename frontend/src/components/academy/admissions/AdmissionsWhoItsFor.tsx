...
const goodFitBullets = [
  "Feel constrained in traditional school environments",
  "Are academically capable and benefit from personalised attention",
  "Want greater ownership of their learning",
  "Value clear academic pathways and thoughtful guidance",
  "Are beginning to think seriously about life beyond school",
];

const familyValues = [
  "Professional guidance and clear communication",
  "Long-term development over short-term compliance",
  "A school that knows their child individually",
];

const notFitBullets = [
  "Prefer large, conventional school settings",
  "Require constant supervision or heavy discipline",
  "Are looking for minimal effort with guaranteed outcomes",
];

export function AdmissionsWhoItsFor() {
  return (
    <SectionFrame id="who-its-for" className="bg-background">
      ...
      >
        ...
        <p className="mt-4 text-sm sm:text-base font-light text-foreground leading-relaxed max-w-2xl">
          Many students also value the flexibility to pursue sport,
          entrepreneurship, or work experience alongside their studies.
        </p>
      </motion.div>
          ...
          <div className="relative h-full rounded-2xl bg-card border border-border shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden flex flex-col">
            ...
            <div className="flex flex-col p-6 flex-1 gap-5">
              ...
              <p className="text-sm font-light text-foreground leading-relaxed pt-1">
                Cohorts are intentionally small, allowing each student to be
                known individually and supported appropriately.
              </p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="relative h-full rounded-2xl bg-card border border-border shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden flex flex-col">
            ...
            <div className="flex flex-col p-6 flex-1 gap-5">
              ...
              <p className="text-sm font-light text-foreground leading-relaxed">
                iCollege Academy may not be the right environment for students
                who have:
              </p>
              ...
              <p className="text-sm font-semibold text-foreground leading-relaxed border-l-2 border-border pl-4 mt-2">
                Students here are expected to engage seriously with their
                learning and take increasing responsibility for their progress.
              </p>

              <p className="text-sm font-light text-foreground leading-relaxed">
                We aim to develop independence, maturity, and personal
                responsibility — not simply enforce compliance.
              </p>
            </div>
          </div>
        </motion.div>
