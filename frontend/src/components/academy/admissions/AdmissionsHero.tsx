      ...
      <div className="relative z-10 w-full">
        <div className="container mx-auto px-6 sm:px-8 lg:px-12 pb-14 md:pb-16 lg:pb-20">
          <div className="flex flex-col gap-5 max-w-lg">
            ...
            >
              Joining iCollege Academy{" "}
              <span className="text-secondary">begins with a conversation.</span>
            </motion.h1>
            ...
            >
              Cohorts are intentionally small, allowing each learner to be
              known individually and supported appropriately. We take care to
              ensure the Academy is the right environment for both the student
              and their family.
            </motion.p>
            ...
            >
              {["Small Cohorts", "Ages 15–18", "Barcelona", "Selective"].map((pill) => (
                <span
                  key={pill}
