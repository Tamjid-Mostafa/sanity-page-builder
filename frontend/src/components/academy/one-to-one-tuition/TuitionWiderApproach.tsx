...
const principles = [
  ...
  "Clarity and structure in every session",
  "Long-term development over short-term fixes",
];

export function TuitionWiderApproach() {
  return (
    <SectionFrame id="wider-approach" className="bg-foreground">
      <motion.div
      ...
      >
        ...
        <h2 className="text-3xl sm:text-4xl md:text-[2.625rem] font-heading font-bold tracking-tight leading-[1.08] text-background">
          Part of a Wider Educational Approach
        </h2>
        <p className="mt-4 text-sm sm:text-base font-light text-background leading-relaxed max-w-xl">
          Private tuition at iCollege Life reflects the same principles as the Academy:
        </p>
      </motion.div>
      ...
      >
        The aim is to build confidence and independence — not reliance.
      </motion.p>
    </SectionFrame>
  );
}
