      ...
      <div className="relative z-10 w-full">
        <div className="container mx-auto px-6 sm:px-8 lg:px-12 pb-14 md:pb-16 lg:pb-20">
          <div className="flex flex-col gap-5 max-w-lg">
            ...
            >
              iCollege Academy · 1-to-1 Tuition
            </motion.span>
            ...
            >
              ...
              <span className="text-secondary">delivered with clarity.</span>
            </motion.h1>
            ...
            >
              Private 1-to-1 tuition for GCSE, IGCSE, A-Level, and
              international qualifications — available to Academy students and
              external families.
            </motion.p>
            ...
            >
              ...
              >
                ...
                >
                  <Link href="mailto:hello@icollegelife.com?subject=Enquiry%20about%201-to-1%20tuition">
            ...
            >
              {["GCSE", "A-Level", "Experienced Tutors", "Online"].map((pill) => (
                <span
                  key={pill}
