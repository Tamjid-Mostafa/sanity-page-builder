...
export function CurriculumFinalCTA() {
  return (
    <SectionFrame id="curriculum-cta" className="bg-foreground">
      <div className="flex flex-col items-center text-center">
        ...
        >
          The best place to start is a conversation. We&apos;ll help you understand
          which pathway fits your situation and what the journey looks like.
        </motion.p>
