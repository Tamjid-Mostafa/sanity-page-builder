...
interface AthletesOutcomesProps {
  tennisImage: ImageBlockData["image"];
}
...
export function AthletesOutcomes({ tennisImage }: AthletesOutcomesProps) {
  return (
          ...
          {tennisImage?.asset && (
            ...
            >
              <SanityImage
                value={{
                  ...tennisImage,
                  alt: tennisImage.alt ?? "Tennis athlete training on court",
                }}
                width={720}
                fill
                sizes="360px"
