...
interface AthletesHeroProps {
  heroImage: ImageBlockData["image"];
}
...
export function AthletesHero({ heroImage }: AthletesHeroProps) {
  return (
    <>
      <section
        className="relative hero-clear-site-header min-h-[88vh] flex items-end bg-black overflow-hidden"
        ...
        {heroImage?.asset && (
          <SanityImage
            value={{
              ...
              alt:
                heroImage.alt ??
                "Student-athletes sprinting during a football match",
            }}
            width={1920}
            fill
            priority
